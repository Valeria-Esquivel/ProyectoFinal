                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="col-xl-11">
                                    <form method="POST" action="/gastosup" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <br>
                                        <input type="hidden" name="id" value="{{$gastos->id}}" class="form-control" required>
                                        ...
                                        <div class="form-group row d-flex align-items-center mb-5">
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" name="descripcion" value="{{$gastos->descripcion}}" class="form-control" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" name="cantidad" value="{{$gastos->cantidad}}" class="form-control" required>
                                                </div>
                                            </div>
                                        
                                        <input type="hidden" name="condicion" value="{{$gastos->condicion}}" class="form-control" required>
                                        </div>
