<div class="widget has-shadow">
        ...
        <div class="row flex-row">
                            ...
                            <div class="widget widget-23 bg-gradient-02 d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="counter"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><h1>${{$p}} </h1>Pagos de Proyectos</font></font></div>
                            ...
                            <!-- Begin Widget 17 -->
                            <div class="col-xl-6 col-md-6">
                            <div class="widget widget-23 bg-gradient-01 d-flex justify-content-center align-items-center">
                                    <div class="widget-body text-center">
                                        <i class="la la-money"></i>
                                    </div>  
                                    <div class="counter"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><h1>${{$g}}</h1>Gastos de Tareas</font></font></div>
