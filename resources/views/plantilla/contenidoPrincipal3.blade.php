...
<div class="row flex-row">
 ...
 <div class="col-xl-6 col-md-6">
                                ...
                                <div class="widget widget-08 has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <div class="today">
                                            <div class="title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{Auth::user()->name}}</font></font></div>
                                            <div class="new-tasks"><span class="nb"><font style="vertical-align: inherit;">
                                            <font style="vertical-align: inherit;">{{$ad}}</font></font></span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> Tickets Sin Contestar</font></font></div>
                                        </div>
                                        <!-- Begin List -->
                                        <div class="todo-list">
                                        @foreach ($aD as $aD)
